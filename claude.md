...
브라질 국채(NTN-F) 이자를 재원으로 월/반기 중 선택한 지급구분에 따라 분배하는 특정금전신탁 상품의 현금흐름 계산기입니다. (재투자형은 보류) `post0318/fix`(범용 채권 계산기, 미국/한국/브라질 다국가 지원)를 브라질 전용으로 정리해 시작했습니다. 정식 규칙은 PRD.md 참고 — 1단계는 반기지급만 구현되어 있고 월/재투자는 예정입니다.
